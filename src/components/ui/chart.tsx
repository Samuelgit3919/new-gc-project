// This file is already valid React JSX with TypeScript types (TSX)
// To convert it to pure JSX, we remove TypeScript types and switch to JS modules

import React, { useContext, useEffect, useMemo, useId, createContext } from "react"
...
function getPayloadConfigFromPayload(config, payload, key) {
  ...
  const innerPayload = payload.payload && typeof payload.payload === "object" ? payload.payload : undefined
  let configKey = key
